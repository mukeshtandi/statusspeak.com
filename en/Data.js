...
//Index Page Images
$('#wish1').attr('src','chenwish1.gif');
$('#main1').attr('src','chenmain1.gif');
$('#under1').attr('src','santaji6.gif');
$('#under2').attr('src','santaji2.gif');

//Share Page Images
$('#wish2').attr('src','chenwish1.gif');
$('#main2').attr('src','chenmain1.gif');
$('#under3').attr('src','santaji6.gif');
$('#under4').attr('src','santaji2.gif');
